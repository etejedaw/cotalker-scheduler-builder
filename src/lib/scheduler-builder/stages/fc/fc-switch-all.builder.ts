...
const FCSwitchAllSchema = z.object({
	lexpression: z.any(),
	rcaseA: z.any(),
	rcaseB: z.any(),
	rcaseC: z.any(),
...
type FCSwitchAllData = z.infer<typeof FCSwitchAllSchema>;
...
export class FCSwitchAllBuilder extends StageBuilder<FCSwitchAllData, NextStage> {
	constructor(key: string) {
		super(key, "FCSwitchAll", null, FCSwitchAllSchema);
		this.next.CASE_A = "";
		this.next.CASE_B = "";
		this.next.CASE_C = "";
		this.next.CASE_D = "";
